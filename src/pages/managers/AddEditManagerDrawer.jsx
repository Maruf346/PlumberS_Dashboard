...
// Right-side 512px drawer — Add or Edit Manager.
// Add mode  → fields: first_name, last_name, profile_picture, email, phone, password, confirm_password
// Edit mode → fields: first_name, last_name, profile_picture, email, phone  (no password change)
//
// API (commented out — uncomment when backend is ready):
//   POST  VITE_API_BASE_URL + user/admin/managers/create/
//   Body: { first_name, last_name, profile_picture, email, phone, password, confirm_password }
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="flex flex-col gap-[6px]">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={[
            'w-full h-[38px] rounded-[8px] border text-[14px] text-[#0f172b] pl-9 pr-10 py-[9px]',
            'placeholder:text-[#90a1b9] transition-colors',
            error
      ...
      <div className="flex items-start justify-between px-6 pt-5 pb-5 border-b border-[#e2e8f0]">
        <div>
          ...
          <p className="text-[#62748e] text-[14px] leading-[20px] mt-1">
            {isEdit ? `Editing ${initialData?.name ?? 'manager'}` : 'Create a new manager account'}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-7">
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  ...
                  {form.profile_picture && (
                    <>
                      ...
                      <button type="button"
                        onClick={() => setForm(p => ({ ...p, profile_picture: null }))}
          ...
          <section className="flex flex-col gap-4">
            ...
            <FormInput
              ...
              placeholder="e.g. sarah.lee@company.com"
