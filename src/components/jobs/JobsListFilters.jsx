// src/components/jobs/JobsListFilters.jsx
...
function IconCalendar() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <rect x="1" y="2" width="12" height="11" rx="1.5" stroke="#62748e" strokeWidth="1.1"/>
      <path d="M4.5 1v2.5M9.5 1v2.5M1 5.5h12" stroke="#62748e" strokeWidth="1.1" strokeLinecap="round"/>
    </svg>
  )
}
    ...
    <div className="relative">
      ...
      <select
        ...
        className={[
          ...
          'pr-8 py-[9px] text-[13px] leading-[20px] transition-colors cursor-pointer',
          Icon ? 'pl-8' : 'pl-3',
      ...
      <span className="absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none text-[#90a1b9]">
        <IconChevronDown />
      </span>
    </div>
  )
    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 flex-wrap">
      ...
      <div className="relative flex-1 min-w-[200px] sm:max-w-[340px]">
        ...
        <input
          ...
          placeholder="Search by Job ID, Client, or Address..."
          className={[
